        ...
        <div className="grid lg:grid-cols-5 gap-16 lg:gap-20 items-center">
          ...
          <div className="lg:col-span-3 space-y-0">
            ...
            <div className="space-y-5">
              {about.paragraphs.map((text, i) => (
                <SectionReveal key={i} delay={0.1 * (i + 1)}>
                  <p className="text-base md:text-lg font-sans text-muted-foreground leading-[1.8] text-left whitespace-pre-line">
                    {text}
                  </p>
                </SectionReveal>
              ))}
            ...
            <SectionReveal delay={0.3}>
              <div className="pt-6 flex items-center justify-center gap-4 text-xs font-sans tracking-widest uppercase text-muted-foreground/70">
